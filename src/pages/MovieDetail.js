...
export const MovieDetail = () => {
  ...
  useEffect(()=>{
    const fetchMovie = async ()=>{
      const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=401d56fe6b88040607981be1d6310a55`)
          ...
          <div  className="max-w-sm">
              <img src={image} alt=""/>
                  ...
                  <div className="max-w-2xl text-gray-700 text-lg dark:text-white">
                    <h1 className = "text-2xl font-bold py-3 text-center lg:text-left">{movie.original_title}</h1>
